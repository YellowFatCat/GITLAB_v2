...
public class Issue extends Resource {
    ...
    public static final class FluentCreate {
        ...
        private FluentCreate(JiraRestClient restclient, JSONObject createmeta) {
    ...
    public static final class FluentRemoteLink {
        ...
        final private JiraRestClient restclient;
        final private String key;
        final private JSONObject request;
        final private JSONObject object;


        private FluentRemoteLink(final JiraRestClient restclient, String key) {
            this.restclient = restclient;
            this.key = key;
     ...
     */
    public static int count(JiraRestClient restclient, String jql) throws JiraException {
        final String j = jql;
        JSON result = null;
        try {
    ...
    private static class IssueIterator implements Iterator<Issue> {
        ...
        public IssueIterator(JiraRestClient restclient, String jql, String includedFields,
    ...
    public static class SearchResult {
        ...
        public SearchResult(JiraRestClient restclient, String jql, String includedFields,
                            String expandFields, Integer maxResults, Integer startAt)
                throws JiraException {
...
//    private List<WorkLog> workLogs = null;
     ...
     */
    public Issue(JiraRestClient restclient, JSONObject json) {
        super(restclient);
...
//        workLogs = Field.getWorkLogs(fields.get(Field.WORKLOG), restclient);
    ...
    public static JSONObject getCreateMetadata(
            JiraRestClient restclient, String project, String issueType) throws JiraException {
...
//        return projects.get(0).getIssueTypes().get(0).getFields();
    ...
    private JSONObject getEditMetadata() throws JiraException {
        ...
        try {
            result = restclient.get(new URI(getRestUri(key) + "/editmeta"));
        } catch (Exception ex) {
            throw new JiraException("Failed to retrieve issue metadata", ex);
        }
...
//    }
     ...
     */
    public static FluentCreate create(JiraRestClient restclient, String project, String issueType)
            throws JiraException {
...
//    }
    ...
    private static JSONObject realGet(JiraRestClient restclient, String key, Map<String, String> queryParams)
            throws JiraException {
     ...
     */
    public static Issue get(JiraRestClient restclient, String key)
            throws JiraException {
     ...
     * @throws JiraException when the retrieval fails
     */
    public static Issue get(JiraRestClient restclient, String key, final String includedFields)
            throws JiraException {
     ...
     * @throws JiraException when the search fails
     */
    public static SearchResult search(JiraRestClient restclient, String jql,
     ...
     */
    private static URI createSearchURI(JiraRestClient restclient, String jql,
                                       String includedFields, String expandFields, Integer maxResults,
