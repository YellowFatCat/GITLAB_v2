...
import com.epam.metrics.connectors.rest.jira.models.oldModels.*;
...
//    }
    ...
    public static <T extends Resource> T getResource(
            Class<T> type, Object r, JiraRestClient restclient) {
     ...
     */
    public static <T extends Resource> T getResource(
            Class<T> type, Object r, JiraRestClient restclient, String parentId) {
    ...
    public static <T extends Resource> List<T> getResourceArray(
            Class<T> type, Object ra, JiraRestClient restclient) {
     ...
     */
    public static <T extends Resource> List<T> getResourceArray(
            Class<T> type, Object ra, JiraRestClient restclient, String parentId) {
